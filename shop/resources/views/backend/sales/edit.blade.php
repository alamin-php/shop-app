                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('product')}}" class="btn btn-primary btn-sm" style="float:right"><i class="fa fa-undo"></i>
                                Back</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{route('product.update', $product->id)}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="quality_id" id="" class="form-control">
                                        ...
                                        <option value="{{ $row->id }}"  @if($row->id == $product->quality_id) selected @endif>{{ $row->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
