                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('quality.edit', $row->id) }}" class="text-success"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('quality.delete', $row->id) }}" class="text-danger"><i class="fa fa-trash"></i></a>
                        </td>
                        </tr>
